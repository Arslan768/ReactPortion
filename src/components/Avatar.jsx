  ...
  */
  ...
  export function Avatar(props) {
    ...
    const jsonFile = useLoader(THREE.FileLoader, `temp/${script}.json`);
    ...
    //   const audio = new Audio(`/audios/${script}.mp3?cacheBust=${new Date().getTime()}`);
    ...
    //   // };
    // }, [playAudio, script]); // End of the cache-busting audio logic change
